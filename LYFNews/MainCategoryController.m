...
- (void)categoryIconViewSelected:(NSString *)category
{
    ...
    } else if ([category isEqualToString:@"独家新闻"]) {
...
- (NSMutableArray *)categoryOneArray
{
    if (!_categoryOneArray) {
        _categoryOneArray = [[NSMutableArray alloc] initWithObjects:@"播客", @"有声小说", @"独家新闻", @"读书计划",@"新闻",@"谈话",@"娱乐",@"凤凰汇",@"相声小品",@"评书曲艺",@"文史军事",@"亲子",@"情感",@"财经科技",@"电台直播",@"更多",nil];
    }
